...
const createReduxRequestsFactory = <Key extends string = typeof DEFAULT_STATE_REQUESTS_KEY>(
  ...
  return {
    ...
    createRequestsFactoryMiddleware: getCreateRequestsFactoryMiddleware<Key>(preparedConfig),
