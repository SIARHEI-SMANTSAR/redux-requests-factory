...
type RequestsFactoryItemCommonSelectorsWithoutSerialize<_Resp, Err, _Params, State> = {
...
type RequestsFactoryItemCommonSelectorsWithSerialize<_Resp, Err, Params, State> = {
...
export type RequestsFactoryItemSelectorsWithoutSerialize<Resp, Err, Params, State> =
  RequestsFactoryItemCommonSelectorsWithoutSerialize<Resp, Err, Params, State> & {
...
export type RequestsFactoryItemSelectorsWithSerialize<Resp, Err, Params, State> =
  RequestsFactoryItemCommonSelectorsWithSerialize<Resp, Err, Params, State> & {
...
export type RequestsFactoryItemSelectors<Resp, Err, Params, State, TransformedResp> =
